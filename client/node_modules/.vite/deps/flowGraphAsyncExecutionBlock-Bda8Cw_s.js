import { t as FlowGraphExecutionBlockWithOutSignal } from "./flowGraphExecutionBlockWithOutSignal-B4Dl2-qq.js";
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/FlowGraph/flowGraphAsyncExecutionBlock.js
/**
...
var FlowGraphAsyncExecutionBlock = class extends FlowGraphExecutionBlockWithOutSignal {
	constructor(config, events) {
		...
		if (events) for (const eventName of events) this._eventsSignalOutputs[eventName] = this._registerSignalOutput(eventName + "Event");
	}
	/**
	* @internal
...
//#endregion
export { FlowGraphAsyncExecutionBlock as t };

...
import { i as TmpVectors, o as Vector3, t as Matrix } from "./math.vector.pure-BrntvQ1d.js";
import { t as EngineStore } from "./engineStore-BG5VoWzz.js";
import { r as RegisterClass, t as GetClass } from "./typeStore-D6p3QRUb.js";
import { R as EncodeArrayBufferToBase64, o as InstantiationTools } from "./tools.pure-DiR-ZH3i.js";
import { i as _WarnImport, n as _MissingSideEffect, r as _MissingSideEffectProperty } from "./devTools-B-EiaEIm.js";
import { C as __esDecorate, i as serialize, m as serializeAsTexture, w as __runInitializers } from "./decorators-BbBwhhmu.js";
import { n as SerializationHelper, t as Size } from "./math.size-Bg8qa66I.js";
import { o as TimingTools } from "./tools.functions-BTDeKQCt.js";
import { n as RandomGUID } from "./guid-DaqsusMN.js";
import { t as Plane } from "./math.plane-D1doVXIl.js";
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Compat/compatibilityOptions.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Materials/Textures/thinTexture.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Materials/Textures/baseTexture.pure.js
		...
		*/
		constructor(sceneOrEngine, internalTexture = null) {
			...
			*/
			...
			if (sceneOrEngine) {
				if (_a._IsScene(sceneOrEngine)) this._scene = sceneOrEngine;
...
//#endregion
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Misc/copyTools.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Materials/Textures/texture.pure.js
/** This file must only contain pure code and pure imports */
/**
...
var Texture = (() => {
	...
	return _a = class Texture extends _classSuper {
		...
		*/
		constructor(url, sceneOrEngine, noMipmapOrOptions, invertY, samplingMode = _a.TRILINEAR_SAMPLINGMODE, onLoad = null, onError = null, buffer = null, deleteBuffer = false, format, mimeType, loaderOptions, creationFlags, forcedExtension) {
			...
			*/
			this.uScale = (__runInitializers(this, _vOffset_extraInitializers), __runInitializers(this, _uScale_initializers, 1));
			/**
			* Define an offset on the texture to scale the v coordinates of the UVs
			* @see https://doc.babylonjs.com/features/featuresDeepDive/materials/using/moreMaterials#tiling
			*/
			this.vScale = (__runInitializers(this, _uScale_extraInitializers), __runInitializers(this, _vScale_initializers, 1));
			/**
			...
			*/
			this.uRotationCenter = (__runInitializers(this, _wAng_extraInitializers), __runInitializers(this, _uRotationCenter_initializers, .5));
			/**
			* Defines the center of rotation (V)
			*/
			this.vRotationCenter = (__runInitializers(this, _uRotationCenter_extraInitializers), __runInitializers(this, _vRotationCenter_initializers, .5));
			/**
			* Defines the center of rotation (W)
			*/
			this.wRotationCenter = (__runInitializers(this, _vRotationCenter_extraInitializers), __runInitializers(this, _wRotationCenter_initializers, .5));
			/**
			...
			*/
			...
			} else noMipmap = !!noMipmapOrOptions;
			...
			if (format !== void 0) this._format = format;
			const scene = this.getScene();
			const engine = this._getEngine();
			if (!engine) return;
			...
			const load = () => {
				...
				if (this.onLoadObservable.hasObservers()) this.onLoadObservable.notifyObservers(this);
				if (onLoad) onLoad();
				if (!this.isBlocking && scene) scene.resetCachedMaterial();
			};
			...
			} else if (this._texture.isReady) TimingTools.SetImmediate(() => load());
			else {
		...
		*/
		updateURL(url, buffer = null, onLoad, forcedExtension) {
			...
			if (!this.name || this.name.startsWith("data:")) this.name = url;
			this.url = url;
			this._buffer = buffer;
			this._forcedExtension = forcedExtension;
			this.delayLoadState = 4;
			...
			const load = () => {
				...
				else if (this.onLoadObservable.hasObservers()) this.onLoadObservable.notifyObservers(this);
				if (onLoad) onLoad();
			};
			this._delayedOnLoad = load;
			this.delayLoad();
		...
		*/
		delayLoad() {
			...
			if (!scene) return;
			let url = this.url;
			if (!url && (this.name.indexOf("://") > 0 || this.name.startsWith("data:"))) url = this.name;
			...
			} else if (this._delayedOnLoad) {
				if (this._texture.isReady) TimingTools.SetImmediate(this._delayedOnLoad);
				else this._texture.onLoadedObservable.add(this._delayedOnLoad);
			}
			this._delayedOnLoad = null;
			this._delayedOnError = null;
		}
		...
		*/
		getTextureMatrix(uBase = 1) {
			...
			if (this.optimizeUVAllocation && previousIdentity3x2 !== this._cachedIdentity3x2) scene.markAllMaterialsAsDirty(1, (mat) => {
				return mat.hasTexture(this);
			});
		...
		*/
		getReflectionTextureMatrix() {
			...
			if (!this._cachedReflectionTextureMatrix) this._cachedReflectionTextureMatrix = Matrix.Zero();
			if (!this._projectionModeMatrix) this._projectionModeMatrix = Matrix.Zero();
			...
			switch (this.coordinatesMode) {
				...
				default: Matrix.IdentityToRef(this._cachedReflectionTextureMatrix);
			}
			if (flagMaterialsAsTextureDirty) scene.markAllMaterialsAsDirty(1, (mat) => {
				return mat.hasTexture(this);
			});
		...
		*/
		serialize() {
			...
			if (!_a.SerializeBuffers) {
				if (this.name.startsWith("data:")) this.name = "";
			}
			if (this.name.startsWith("data:") && this.url === this.name) this.url = "";
			const serializationObject = super.serialize(_a._SerializeInternalTextureUniqueId);
			if (!serializationObject) return null;
			if (_a.SerializeBuffers || _a.ForceSerializeBuffers) {
				...
				} else if (this.url && this.url.startsWith("data:") && this._buffer instanceof Uint8Array) serializationObject.base64String = `data:${this.mimeType || "image/png"};base64,${EncodeArrayBufferToBase64(this._buffer)}`;
				else if (_a.ForceSerializeBuffers || this.url && this.url.startsWith("blob:") || this._forceSerialize) serializationObject.base64String = !this._engine || this._engine._features.supportSyncTextureRead ? GenerateBase64StringFromTexture(this) : GenerateBase64StringFromTextureAsync(this);
			}
			serializationObject.invertY = this._invertY;
			serializationObject.samplingMode = this.samplingMode;
			serializationObject._creationFlags = this._creationFlags;
			serializationObject._useSRGBBuffer = this._useSRGBBuffer;
			if (_a._SerializeInternalTextureUniqueId) serializationObject.internalTextureUniqueId = this._texture?.uniqueId;
		...
		static Parse(parsedTexture, scene, rootUrl) {
			if (parsedTexture.customType) {
				...
				if (parsedTexture.samplingMode && parsedCustomTexture.updateSamplingMode && parsedCustomTexture._samplingMode) {
					if (parsedCustomTexture._samplingMode !== parsedTexture.samplingMode) parsedCustomTexture.updateSamplingMode(parsedTexture.samplingMode);
				}
			...
			const onLoaded = (texture) => {
				...
				if (parsedTexture.samplingMode) {
					...
					if (texture && texture.samplingMode !== sampling) texture.updateSamplingMode(sampling);
				}
				if (texture && parsedTexture.animations) for (let animationIndex = 0; animationIndex < parsedTexture.animations.length; animationIndex++) {
					...
					if (internalClass) texture.animations.push(internalClass.Parse(parsedAnimation));
				}
				if (texture && texture._texture) {
					if (hasInternalTextureUniqueId && !internalTexture) texture._texture._setUniqueId(parsedTexture.internalTextureUniqueId);
					texture._texture.label = parsedTexture.internalTextureLabel;
				}
			};
			return SerializationHelper.Parse(() => {
				let generateMipMaps = true;
				if (parsedTexture.noMipmap) generateMipMaps = false;
				if (parsedTexture.mirrorPlane) {
					...
					if (typeof parsedTexture.base64String === "string" && parsedTexture.base64String && !internalTexture) {
						...
						let url;
						if (parsedTexture.name && (parsedTexture.name.indexOf("://") > 0 || parsedTexture.name.startsWith("data:"))) url = parsedTexture.name;
						else url = rootUrl + parsedTexture.name;
						if (parsedTexture.url && (parsedTexture.url.startsWith("data:") || _a.UseSerializedUrlIfAny)) url = parsedTexture.url;
						const options = {
							noMipmap: !generateMipMaps,
							invertY: parsedTexture.invertY,
							samplingMode: parsedTexture.samplingMode,
		...
		*/
		static CreateFromBase64String(data, name, scene, noMipmapOrOptions, invertY, samplingMode = _a.TRILINEAR_SAMPLINGMODE, onLoad = null, onError = null, format = 5, creationFlags, forcedExtension) {
			return new _a("data:" + name, scene, noMipmapOrOptions, invertY, samplingMode, onLoad, onError, data, false, format, void 0, void 0, creationFlags, forcedExtension);
		}
		/**
		...
		*/
		static LoadFromDataString(name, buffer, scene, deleteBuffer = false, noMipmapOrOptions, invertY = true, samplingMode = _a.TRILINEAR_SAMPLINGMODE, onLoad = null, onError = null, format = 5, creationFlags, forcedExtension) {
			if (name.substring(0, 5) !== "data:") name = "data:" + name;
			return new _a(name, scene, noMipmapOrOptions, invertY, samplingMode, onLoad, onError, buffer, deleteBuffer, format, void 0, void 0, creationFlags, forcedExtension);
		}
	}, (() => {
		const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
		...
		__esDecorate(_a, null, _get_isBlocking_decorators, {
			kind: "getter",
			name: "isBlocking",
			static: false,
			private: false,
		...
		__esDecorate(null, null, _uOffset_decorators, {
			kind: "field",
			name: "uOffset",
			static: false,
			private: false,
			...
			metadata: _metadata
		}, _uOffset_initializers, _uOffset_extraInitializers);
		__esDecorate(null, null, _vOffset_decorators, {
			kind: "field",
			name: "vOffset",
			static: false,
			private: false,
			...
			metadata: _metadata
		}, _vOffset_initializers, _vOffset_extraInitializers);
		__esDecorate(null, null, _uScale_decorators, {
			kind: "field",
			name: "uScale",
			static: false,
			private: false,
			...
			metadata: _metadata
		}, _uScale_initializers, _uScale_extraInitializers);
		__esDecorate(null, null, _vScale_decorators, {
			kind: "field",
			name: "vScale",
			static: false,
			private: false,
			...
			metadata: _metadata
		}, _vScale_initializers, _vScale_extraInitializers);
		__esDecorate(null, null, _uAng_decorators, {
			kind: "field",
			name: "uAng",
			static: false,
			private: false,
			...
			metadata: _metadata
		}, _uAng_initializers, _uAng_extraInitializers);
		__esDecorate(null, null, _vAng_decorators, {
			kind: "field",
			name: "vAng",
			static: false,
			private: false,
			...
			metadata: _metadata
		}, _vAng_initializers, _vAng_extraInitializers);
		__esDecorate(null, null, _wAng_decorators, {
			kind: "field",
			name: "wAng",
			static: false,
			private: false,
			...
			metadata: _metadata
		}, _wAng_initializers, _wAng_extraInitializers);
		__esDecorate(null, null, _uRotationCenter_decorators, {
			kind: "field",
			...
			metadata: _metadata
		}, _uRotationCenter_initializers, _uRotationCenter_extraInitializers);
		__esDecorate(null, null, _vRotationCenter_decorators, {
			kind: "field",
			...
			metadata: _metadata
		}, _vRotationCenter_initializers, _vRotationCenter_extraInitializers);
		__esDecorate(null, null, _wRotationCenter_decorators, {
			kind: "field",
			...
			metadata: _metadata
		}, _wRotationCenter_initializers, _wRotationCenter_extraInitializers);
		__esDecorate(null, null, _homogeneousRotationInUVTransform_decorators, {
			...
			metadata: _metadata
		}, _homogeneousRotationInUVTransform_initializers, _homogeneousRotationInUVTransform_extraInitializers);
		if (_metadata) Object.defineProperty(_a, Symbol.metadata, {
			enumerable: true,
			configurable: true,
			writable: true,
	...
	})(), _a.SerializeBuffers = true, _a.ForceSerializeBuffers = false, _a.OnTextureLoadErrorObservable = new Observable(), _a._SerializeInternalTextureUniqueId = false, _a._CubeTextureParser = (jsonTexture, scene, rootUrl) => {
...
//#endregion
export { GenerateBase64StringFromTexture as a, ThinTexture as c, useOpenGLOrientationForUV as d, GenerateBase64StringFromPixelData as i, CompatibilityOptions as l, Texture as n, GenerateBase64StringFromTextureAsync as o, CopyTools as r, BaseTexture as s, RegisterTexture as t, setOpenGLOrientationForUV as u };

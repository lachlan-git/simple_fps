...
import { a as IsWindowObjectExist, i as IsNavigatorAvailable, n as GetDOMTextContent, r as IsDocumentAvailable } from "./domManagement-DD_-GDGa.js";
import { t as PrecisionDate } from "./precisionDate-B6nrhdf_.js";
import { _ as _LoadFile, c as Finalize, d as Process, h as _ConcatenateShader, l as Initialize, m as EngineFunctionContext, s as _RetryWithInterval } from "./tools.functions-BTDeKQCt.js";
import { t as ShaderStore } from "./shaderStore-BkcrObRr.js";
import { t as InternalTexture } from "./internalTexture-xO2T2Q2D.js";
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Engines/WebGL/webGLPipelineContext.js
/** @internal */
var WebGLPipelineContext = class {
	...
	_fillEffectInformation(effect, uniformBuffersNames, uniformsNames, uniforms, samplerList, samplers, attributesNames, attributes) {
		...
		let index = 0;
		for (; index < samplerList.length; index++) if (effect.getUniform(samplerList[index]) == null) {
...
//#endregion
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Engines/thinEngine.functions.js
...
//#endregion
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Materials/effect.functions.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Materials/effect.pure.js
...
//#endregion
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/States/depthCullingState.js
/**
* @internal
**/
...
//#endregion
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/States/stencilStateComposer.js
/**
* @internal
**/
...
//#endregion
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/States/stencilState.js
/**
* @internal
**/
...
//#endregion
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/States/alphaCullingState.js
/**
* @internal
**/
	...
	setAlphaMode(mode, targetIndex) {
		...
		switch (mode) {
			...
			case 20:
				...
				break;
			case 21: this.setAlphaBlendFunctionParameters(1, 0, 1, 771, targetIndex);
		}
		this.setAlphaEquationParameters(equation, equation, targetIndex);
	}
};
//#endregion
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Engines/abstractEngine.pure.js
/** This file must only contain pure code and pure imports */
/**
	...
	_createTextureBase(url, noMipmap, invertY, scene, samplingMode = 3, onLoad = null, onError = null, prepareTexture, prepareTextureProcess, buffer = null, fallback = null, format = null, forcedExtension = null, mimeType, loaderOptions, useSRGBBuffer) {
		...
		if (loaderPromise) {
			...
			if (!fromData || isBase64) {
				if (buffer && (typeof buffer.decoding === "string" || buffer.close)) onload(buffer);
...
//#endregion
export { createShaderProgram as _, StencilStateComposer as a, WebGLPipelineContext as b, resetCachedPipeline as c, _finalizePipelineContext as d, _isRenderingStateCompiled as f, createRawShaderProgram as g, createPipelineContext as h, StencilState as i, _createShaderProgram as l, _setProgram as m, QueueNewFrame as n, DepthCullingState as o, _preparePipelineContext as p, AlphaState as r, Effect as s, AbstractEngine as t, _executeWhenRenderingStateIsCompiled as u, deleteStateObject as v, getStateObject as y };

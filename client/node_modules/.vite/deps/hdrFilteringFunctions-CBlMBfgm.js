...
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Shaders/ShadersInclude/importanceSampling.js
var name$1 = "importanceSampling";
var shader$1 = `vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
...
/** @internal */
var importanceSampling = {
	name: name$1,
	shader: shader$1
};
//#endregion
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Shaders/ShadersInclude/hdrFilteringFunctions.js
var name = "hdrFilteringFunctions";
var shader = `#if NUM_SAMPLES
#if NUM_SAMPLES>0
...
//#endregion
export { importanceSampling as n, hdrFilteringFunctions as t };

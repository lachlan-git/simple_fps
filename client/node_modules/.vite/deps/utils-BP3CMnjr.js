import { i as IsNavigatorAvailable } from "./domManagement-DD_-GDGa.js";
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/FlowGraph/utils.js
/**
...
function _GetClassNameOf(v) {
	if (v.getClassName) return v.getClassName();
}
/**
* @internal
...
function isNumeric(a, validIfNaN) {
	...
	if (isNumeric && !validIfNaN) return !isNaN(getNumericValue(a));
	return isNumeric;
}
/**
...
//#endregion
export { _IsDescendantOf as a, isNumeric as c, _GetClassNameOf as i, _AreSameMatrixClass as n, _IsMacPlatform as o, _AreSameVectorOrQuaternionClass as r, getNumericValue as s, _AreSameIntegerClass as t };

import { C as ToHex, t as Clamp, w as WithinEpsilon } from "./math.scalar.functions-DvvDSyEy.js";
import { C as ToGammaSpace, w as ToLinearSpace, x as Epsilon, y as BuildArray } from "./math.vector.pure-BrntvQ1d.js";
import { r as RegisterClass } from "./typeStore-D6p3QRUb.js";
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Maths/math.color.pure.js
...
function ColorChannelToLinearSpaceExact(color) {
	if (color <= .04045) return .0773993808 * color;
	return Math.pow(.947867299 * (color + .055), 2.4);
}
function ColorChannelToGammaSpace(color) {
	return Math.pow(color, ToGammaSpace);
}
function ColorChannelToGammaSpaceExact(color) {
	if (color <= .0031308) return 12.92 * color;
	return 1.055 * Math.pow(color, .41666) - .055;
}
/**
* Class used to hold a RGB color
*/
var Color3 = class Color3 {
	/**
	...
	*/
	fromHexString(hex) {
		if (hex.substring(0, 1) !== "#" || hex.length !== 7) return this;
	...
	toHSVToRef(result) {
		...
		if (max != min) {
			if (max == r) {
				h = (g - b) / dm;
				if (g < b) h += 6;
			} else if (max == g) h = (b - r) / dm + 2;
			else if (max == b) h = (r - g) / dm + 4;
			h *= 60;
		}
		result.r = h;
		result.g = s;
...
*/
Color3._V8PerformanceHack = /*#__PURE__*/ new Color3(.5, .5, .5);
Color3._BlackReadOnly = /*#__PURE__*/ Color3.Black();
/**
* Class used to hold a RBGA color
*/
var Color4 = class Color4 {
	/**
	...
	*/
	clone() {
		return new Color4().copyFrom(this);
	}
	/**
	...
	*/
	fromHexString(hex) {
		if (hex.substring(0, 1) !== "#" || hex.length !== 9 && hex.length !== 7) return this;
		this.r = parseInt(hex.substring(1, 3), 16) / 255;
		this.g = parseInt(hex.substring(3, 5), 16) / 255;
		this.b = parseInt(hex.substring(5, 7), 16) / 255;
		if (hex.length === 9) this.a = parseInt(hex.substring(7, 9), 16) / 255;
		return this;
	}
	/**
	...
	*/
	static FromHexString(hex) {
		if (hex.substring(0, 1) !== "#" || hex.length !== 9 && hex.length !== 7) return new Color4(0, 0, 0, 0);
...
* If we keep using the color instances from step 1, it will now be a poison pill which will mess up optimizations in any code it touches.
*/
Color4._V8PerformanceHack = /*#__PURE__*/ new Color4(.5, .5, .5, .5);
/**
* @internal
*/
var TmpColors = class {};
...
//#endregion
export { TmpColors as i, Color4 as n, RegisterMathColor as r, Color3 as t };

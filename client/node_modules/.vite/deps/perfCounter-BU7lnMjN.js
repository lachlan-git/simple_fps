...
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Misc/perfCounter.js
/**
...
var PerfCounter = class PerfCounter {
	...
	*/
	addCount(newCount, fetchResult) {
		if (!PerfCounter.Enabled) return;
		this._current += newCount;
		this._hasCurrentValue = true;
		if (fetchResult) this._fetchResult();
	}
	/**
	...
	*/
	endMonitoring(newFrame = true) {
		if (!PerfCounter.Enabled) return;
		if (newFrame) this.fetchNewFrame();
		const currentTime = PrecisionDate.Now;
		this._current = currentTime - this._startMonitoringTime;
		this._hasCurrentValue = true;
		if (newFrame) this._fetchResult();
	}
	/**

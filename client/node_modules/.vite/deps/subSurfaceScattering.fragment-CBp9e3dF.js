...
import { t as subSurfaceScatteringFunctions } from "./subSurfaceScatteringFunctions-DZnpdqdp.js";
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Shaders/ShadersInclude/fibonacci.js
var name$2 = "fibonacci";
var shader$2 = `#define rcp(x) 1./x
...
//#endregion
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Shaders/ShadersInclude/diffusionProfile.js
var name$1 = "diffusionProfile";
var shader$1 = `uniform vec3 diffusionS[5];uniform float diffusionD[5];uniform float filterRadii[5];`;
if (!ShaderStore.IncludesShadersStore[name$1]) ShaderStore.IncludesShadersStore[name$1] = shader$1;
/** @internal */
var diffusionProfile = {
	name: name$1,
	shader: shader$1
};
//#endregion
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Shaders/subSurfaceScattering.fragment.js
...
/** @internal */
var subSurfaceScatteringPixelShader = {
	name,
	shader
};
//#endregion
export { subSurfaceScatteringPixelShader };

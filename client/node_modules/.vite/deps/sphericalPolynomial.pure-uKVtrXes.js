import { i as TmpVectors, o as Vector3 } from "./math.vector.pure-BrntvQ1d.js";
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Maths/sphericalPolynomial.pure.js
...
*/
var SphericalHarmonics = class SphericalHarmonics {
	constructor() {
		/**
	...
	*/
	static FromArray(data) {
		return new SphericalHarmonics().updateFromArray(data);
	}
	/**
...
*/
var SphericalPolynomial = class SphericalPolynomial {
	constructor() {
		/**
	...
	*/
	get preScaledHarmonics() {
		if (!this._harmonics) this._harmonics = SphericalHarmonics.FromPolynomial(this);
		if (!this._harmonics.preScaled) this._harmonics.preScaleForRendering();
	...
	*/
	updateFromHarmonics(harmonics) {
		...
		TmpVectors.Vector3[0].copyFrom(harmonics.l20).scaleInPlace(.247708);
		TmpVectors.Vector3[1].copyFrom(harmonics.l22).scaleInPlace(.429043);
		...
		TmpVectors.Vector3[0].copyFrom(harmonics.l20).scaleInPlace(.495417);
	...
	*/
	static FromHarmonics(harmonics) {
		return new SphericalPolynomial().updateFromHarmonics(harmonics);
	}
	/**
...
//#endregion
export { SphericalPolynomial as n, SphericalHarmonics as t };

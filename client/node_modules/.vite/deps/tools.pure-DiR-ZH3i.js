...
import { t as GetClass } from "./typeStore-D6p3QRUb.js";
...
import { a as IsWindowObjectExist, i as IsNavigatorAvailable, n as GetDOMTextContent } from "./domManagement-DD_-GDGa.js";
import { t as PrecisionDate } from "./precisionDate-B6nrhdf_.js";
import { i as Mix, m as EngineFunctionContext, o as TimingTools, p as _FunctionContainer, r as IsExponentOfTwo } from "./tools.functions-BTDeKQCt.js";
import { r as ToHalfFloat, t as FromHalfFloat } from "./halfFloat-CuNBUgay.js";
import { n as RandomGUID } from "./guid-DaqsusMN.js";
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Misc/deepCopier.js
		...
		for (const prop of properties) {
			...
			try {
				if (typeOfSourceValue === "object") {
					if (sourceValue instanceof Uint8Array) destination[prop] = Uint8Array.from(sourceValue);
					else if (sourceValue instanceof Array) {
						destination[prop] = [];
						if (sourceValue.length > 0) {
							if (typeof sourceValue[0] == "object") for (let index = 0; index < sourceValue.length; index++) {
...
//#endregion
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Misc/filesInputStore.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Misc/retryStrategy.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Misc/error.js
/**
...
*/
var AbortError = class AbortError extends BaseError {
...
//#endregion
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Misc/stringTools.js
/**
...
var Decode = (buffer) => {
	...
	let result = "";
	for (let i = 0; i < buffer.byteLength; i++) result += String.fromCharCode(buffer[i]);
	return result;
};
...
//#endregion
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Buffers/bufferUtils.js
...
function AreIndices32Bits(indices, count, start = 0, offset = 0) {
	if (Array.isArray(indices)) {
		for (let index = 0; index < count; index++) if (indices[start + index] - offset > 65535) return true;
		return false;
	}
...
function CreateAlignedTypedArray(type, elementCount) {
	...
	if ((byteSize & 3) === 0) return new type(elementCount);
	byteSize = byteSize + 3 & -4;
	return new type(new ArrayBuffer(byteSize), 0, elementCount);
}
/**
...
//#endregion
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Misc/fileTools.pure.js
...
var SetCorsBehavior = (url, element) => {
	...
	if (FileToolsOptions.CorsBehavior) {
		if (typeof FileToolsOptions.CorsBehavior === "string" || FileToolsOptions.CorsBehavior instanceof String) element.crossOrigin = FileToolsOptions.CorsBehavior;
		else {
...
var GetMimeType = (url) => {
	const { match, type } = TestBase64DataUrl(url);
	if (match) return type || void 0;
	const lastDot = url.lastIndexOf(".");
	switch (url.substring(lastDot + 1).toLowerCase()) {
...
//#endregion
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Misc/instantiationTools.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Misc/tools.pure.js
var tools_pure_exports = /* @__PURE__ */ __exportAll({
	AsyncLoop: () => AsyncLoop,
...
var Tools = class {
	...
	* @returns the angle in degrees
	*/
	static SmoothAngleChange(previousAngle, newAngle, smoothFactor = .9) {
	...
	static _LoadScriptNative(scriptUrl, onSuccess, onError, _scriptId, useModule = false) {
		if (_native) {
			if (useModule) {
				...
				onError?.(message, /* @__PURE__ */ new Error(message));
				return;
			}
	...
	*/
	static ToBlob(canvas, successCallback, mimeType = "image/png", quality) {
		if (!_a._IsOffScreenCanvas(canvas) && !canvas.toBlob) canvas.toBlob = function(callback, type, quality) {
			setTimeout(() => {
	...
	*/
	...
	static _StartMarkNative(counterName, condition = true) {
		if (condition && _native?.startPerformanceCounter) {
			if (_a._NativePerformanceCounterHandles.has(counterName)) _a.Warn(`Performance counter with name ${counterName} is already started.`);
			else {
...
//#endregion
export { GetBlobBufferSource as A, PadNumber as B, SetCorsBehavior as C, CopyFloatData as D, AreIndices32Bits as E, Decode as F, ErrorCodes as G, StringTools as H, DecodeBase64ToBinary as I, FilesInputStore as J, RuntimeError as K, DecodeBase64ToString as L, GetTypeByteLength as M, GetTypedArrayConstructor as N, CreateAlignedTypedArray as O, GetTypedArrayData as P, EncodeArrayBufferToBase64 as R, RequestFileError as S, _injectLTSFileTools as T, AbortError as U, StartsWith as V, BaseError as W, DeepCopier as Y, LoadImageConfiguration as _, tools_pure_exports as a, RegisterFileTools as b, DecodeBase64UrlToString as c, GetMimeType as d, IsBase64DataUrl as f, LoadImage as g, LoadFileError as h, className as i, GetFloatData as j, EnumerateFloatValues as k, FileTools as l, LoadFile as m, RegisterTools as n, InstantiationTools as o, IsFileURL as p, RetryStrategy as q, Tools as r, DecodeBase64UrlToBinary as s, AsyncLoop as t, FileToolsOptions as u, ReadFile as v, TestBase64DataUrl as w, RequestFile as x, ReadFileError as y, EndsWith as z };

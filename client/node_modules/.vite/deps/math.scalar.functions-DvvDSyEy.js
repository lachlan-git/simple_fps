...
//#endregion
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Maths/math.scalar.functions.js
var math_scalar_functions_exports = /* @__PURE__ */ __exportAll({
	Clamp: () => Clamp,
...
function InverseLerp(a, b, value) {
	let result;
	if (a != b) result = Clamp((value - a) / (b - a));
	else result = 0;
	return result;
}
/**
...
function MoveTowards(current, target, maxDelta) {
	let result;
	if (Math.abs(target - current) <= maxDelta) result = target;
	else result = current + Math.sign(target - current) * maxDelta;
	return result;
}
/**
...
function MoveTowardsAngle(current, target, maxDelta) {
	...
	let result;
	if (-maxDelta < num && num < maxDelta) result = target;
	else {
		target = current + num;
...
//#endregion
export { ToHex as C, __exportAll as E, SmoothStep as S, math_scalar_functions_exports as T, PercentToRange as _, Hermite as a, RangeToPercent as b, ILog2 as c, LerpAngle as d, MoveTowards as f, OutsideRange as g, NormalizeRadians as h, ExtractAsInt as i, InverseLerp as l, Normalize as m, DeltaAngle as n, Hermite1stDerivative as o, MoveTowardsAngle as p, Denormalize as r, HighestCommonFactor as s, Clamp as t, Lerp as u, PingPong as v, WithinEpsilon as w, Repeat as x, RandomRange as y };

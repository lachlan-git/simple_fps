...
import { r as Tools } from "./tools.pure-DiR-ZH3i.js";
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Misc/workerPool.js
/**
...
*/
var AutoReleaseWorkerPool = class AutoReleaseWorkerPool extends WorkerPool {
...
//#endregion
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Materials/Textures/ktx2decoderTypes.js
...
//#endregion
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Misc/khronosTextureContainer2Worker.js
	...
	onmessage = (event) => {
		...
		switch (event.data.action) {
			...
			case "setDefaultDecoderOptions":
				...
				break;
			case "decode": ktx2Decoder.decode(event.data.data, event.data.caps, event.data.options).then((data) => {
				const buffers = [];
...
//#endregion
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Misc/khronosTextureContainer2.js
var khronosTextureContainer2_exports = /* @__PURE__ */ __exportAll({
	DefaultKTX2DecoderOptions: () => DefaultKTX2DecoderOptions,
	KhronosTextureContainer2: () => KhronosTextureContainer2
});
/**
...
*/
var KhronosTextureContainer2 = class KhronosTextureContainer2 {
	static GetDefaultNumWorkers() {
		if (typeof navigator !== "object" || !navigator.hardwareConcurrency) return 1;
		return Math.min(Math.floor(navigator.hardwareConcurrency * .5), 4);
	}
	static _Initialize(numWorkers) {
		if (KhronosTextureContainer2._WorkerPoolPromise || KhronosTextureContainer2._DecoderModulePromise) return;
		const urls = {
		...
		if (numWorkers && typeof Worker === "function" && typeof URL !== "undefined") KhronosTextureContainer2._WorkerPoolPromise = new Promise((resolve) => {
		...
		else if (typeof KhronosTextureContainer2._KTX2DecoderModule === "undefined") KhronosTextureContainer2._DecoderModulePromise = Tools.LoadBabylonScriptAsync(urls.jsDecoderModule).then(() => {
	...
	*/
	constructor(engine, numWorkersOrOptions = KhronosTextureContainer2.DefaultNumWorkers) {
		...
		if (workerPoolOption) KhronosTextureContainer2._WorkerPoolPromise = Promise.resolve(workerPoolOption);
		else {
			if (typeof numWorkersOrOptions === "object") KhronosTextureContainer2._KTX2DecoderModule = numWorkersOrOptions?.binariesAndModulesContainer?.jsDecoderModule;
			else if (typeof KTX2DECODER !== "undefined") KhronosTextureContainer2._KTX2DecoderModule = KTX2DECODER;
	...
	*/
	async _decodeAsync(data, options) {
		...
		if (KhronosTextureContainer2._WorkerPoolPromise) {
				...
				workerPool.push((worker, onComplete) => {
					...
					const onMessage = (message) => {
						if (message.data.action === "decoded") {
							...
							else resolve(message.data.decodedData);
							onComplete();
						}
					};
					worker.addEventListener("error", onError);
			...
			if (KhronosTextureContainer2.DefaultDecoderOptions.isDirty) KhronosTextureContainer2._KTX2DecoderModule.KTX2Decoder.DefaultDecoderOptions = KhronosTextureContainer2.DefaultDecoderOptions._getKTX2DecoderOptions();
			return await new Promise((resolve, reject) => {
				decoder.decode(data, caps, options).then((decodedData) => {
					resolve(decodedData);
				}).catch((reason) => {
	...
	_createTexture(data, internalTexture, options) {
		if ((data.layerCount ?? 1) > 1) throw new Error("KTX2 container - array textures are not supported by this texture loader.");
...
//#endregion
export { workerFunction as a, TranscodeTarget as c, initializeWebWorker as i, AutoReleaseWorkerPool as l, KhronosTextureContainer2 as n, EngineFormat as o, khronosTextureContainer2_exports as r, SourceTextureFormat as s, DefaultKTX2DecoderOptions as t, WorkerPool as u };

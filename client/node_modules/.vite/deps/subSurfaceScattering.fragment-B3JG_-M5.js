...
import { t as subSurfaceScatteringFunctionsWGSL } from "./subSurfaceScatteringFunctions-dPS1UKlZ.js";
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/fibonacci.js
var name$2 = "fibonacci";
var shader$2 = `fn rcp(x: f32)->f32
{return 1./x;}
...
//#endregion
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/diffusionProfile.js
var name$1 = "diffusionProfile";
var shader$1 = `uniform diffusionS: array<vec3f,5>;uniform diffusionD: array<f32,5>;uniform filterRadii: array<f32,5>;
`;
if (!ShaderStore.IncludesShadersStoreWGSL[name$1]) ShaderStore.IncludesShadersStoreWGSL[name$1] = shader$1;
/** @internal */
var diffusionProfileWGSL = {
	name: name$1,
	shader: shader$1
};
//#endregion
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/ShadersWGSL/subSurfaceScattering.fragment.js
...
/** @internal */
var subSurfaceScatteringPixelShaderWGSL = {
	name,
	shader
};
//#endregion
export { subSurfaceScatteringPixelShaderWGSL };

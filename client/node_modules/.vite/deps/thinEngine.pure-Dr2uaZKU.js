import { E as __exportAll } from "./math.scalar.functions-DvvDSyEy.js";
import { t as Logger } from "./logger-CVZpwFO0.js";
import { a as IsWindowObjectExist } from "./domManagement-DD_-GDGa.js";
import { g as _GetGlobalDefines, h as _ConcatenateShader, n as GetExponentOfTwo } from "./tools.functions-BTDeKQCt.js";
import { _ as createShaderProgram, c as resetCachedPipeline, d as _finalizePipelineContext, f as _isRenderingStateCompiled, g as createRawShaderProgram, h as createPipelineContext, l as _createShaderProgram, m as _setProgram, p as _preparePipelineContext, r as AlphaState, s as Effect, t as AbstractEngine, u as _executeWhenRenderingStateIsCompiled, v as deleteStateObject, y as getStateObject } from "./abstractEngine.pure-CImT488Y.js";
import { t as InternalTexture } from "./internalTexture-xO2T2Q2D.js";
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Buffers/dataBuffer.js
/**
* Class used to store gfx data (like WebGLBuffer)
*/
var DataBuffer = class DataBuffer {
	/**
...
//#endregion
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Materials/drawWrapper.functions.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Engines/WebGL/webGLShaderProcessors.js
/** @internal */
var WebGLShaderProcessor = class {
	...
	postProcessor(code, defines, isFragment, processingContext, parameters) {
		if (parameters.drawBuffersExtensionDisabled) code = code.replace(/#extension.+GL_EXT_draw_buffers.+(enable|require)/g, "");
		return code;
	}
};
//#endregion
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Engines/WebGL/webGL2ShaderProcessors.js
...
var WebGL2ShaderProcessor = class {
	...
	postProcessor(code, defines, isFragment) {
		...
		code = code.replace(/#extension.+(GL_OVR_multiview2|GL_OES_standard_derivatives|GL_EXT_shader_texture_lod|GL_EXT_frag_depth|GL_EXT_draw_buffers).+(enable|require)/g, "");
		...
		if (isFragment) {
			...
			if (defines.indexOf("#define VERTEXOUTPUT_INVARIANT") >= 0) code = "invariant gl_Position;\n" + code;
			if (defines.indexOf("#define MULTIVIEW") !== -1) return "#extension GL_OVR_multiview2 : require\nlayout (num_views = 2) in;\n" + code;
		}
		return code;
	}
};
//#endregion
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Meshes/WebGL/webGLDataBuffer.js
/** @internal */
...
//#endregion
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Engines/WebGL/webGLHardwareTexture.js
/** @internal */
var WebGLHardwareTexture = class {
	...
	constructor(existingTexture = null, context) {
		...
		if (!existingTexture) {
			...
			if (!existingTexture) throw new Error("Unable to create webGL texture");
		}
	...
	addMSAARenderBuffer(buffer) {
		if (!this._MSAARenderBuffers) this._MSAARenderBuffers = [];
		this._MSAARenderBuffers.push(buffer);
	}
	releaseMSAARenderBuffers() {
		if (this._MSAARenderBuffers) {
			for (const buffer of this._MSAARenderBuffers) this._context.deleteRenderbuffer(buffer);
			this._MSAARenderBuffers = null;
		}
	}
	...
	release() {
		...
		if (this._webGLTexture) this._context.deleteTexture(this._webGLTexture);
		this.reset();
	}
};
//#endregion
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Materials/Textures/textureHelper.functions.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Engines/thinEngine.pure.js
/** This file must only contain pure code and pure imports */
var thinEngine_pure_exports = /* @__PURE__ */ __exportAll({ ThinEngine: () => ThinEngine });
/**
...
*/
var ThinEngine = class ThinEngine extends AbstractEngine {
	/**
	...
	constructor(canvasOrContext, antialias, options, adaptToDeviceRatio) {
		...
		*/
		...
		if (canvasOrContext.getContext) {
			...
			if (options.preserveDrawingBuffer === void 0) options.preserveDrawingBuffer = false;
			if (options.xrCompatible === void 0) options.xrCompatible = false;
			if (navigator && navigator.userAgent) {
				...
				for (const exception of ThinEngine.ExceptionList) {
					...
					if (new RegExp(key).test(ua)) {
						if (exception.capture && exception.captureConstraint) {
							const capture = exception.capture;
							const constraint = exception.captureConstraint;
							const matches = new RegExp(capture).exec(ua);
							if (matches && matches.length > 0) {
								if (parseInt(matches[matches.length - 1]) >= constraint) continue;
							}
						}
						for (const target of targets) switch (target) {
							...
							case "antialias":
								...
								break;
							case "maxMSAASamples": this._maxMSAASamplesOverride = 1;
						}
					}
				}
			}
			...
			} else this._onContextLost = () => {
				deleteStateObject(this._gl);
			};
			canvas.addEventListener("webglcontextlost", this._onContextLost, false);
			if (this._badDesktopOS) options.xrCompatible = false;
			if (!options.disableWebGL2Support) try {
			...
			if (!this._gl) {
				if (!canvas) throw new Error("The provided canvas is null or undefined.");
				try {
			...
			if (this._gl.renderbufferStorageMultisample) {
				this._webGLVersion = 2;
				this._shaderPlatformName = "WEBGL2";
			} else this._shaderPlatformName = "WEBGL1";
			const attributes = this._gl.getContextAttributes();
			if (attributes) options.stencil = attributes.stencil;
		}
		this._sharedInit(canvas);
		this._gl.pixelStorei(this._gl.UNPACK_COLORSPACE_CONVERSION_WEBGL, this._gl.NONE);
		if (options.useHighPrecisionFloats !== void 0) this._highPrecisionShadersAllowed = options.useHighPrecisionFloats;
		this.resize();
		this._initGLContext();
		this._initFeatures();
		for (let i = 0; i < this._caps.maxVertexAttribs; i++) this._currentBufferPointers[i] = new BufferPointer();
		this._shaderProcessor = this.webGLVersion > 1 ? new WebGL2ShaderProcessor() : new WebGLShaderProcessor();
		const versionToLog = `Babylon.js v${ThinEngine.Version}`;
		Logger.Log(versionToLog + ` - ${this.description}`);
		if (this._renderingCanvas && this._renderingCanvas.setAttribute) this._renderingCanvas.setAttribute("data-engine", versionToLog);
	...
	*/
	areAllEffectsReady() {
		for (const key in this._compiledEffects) if (!this._compiledEffects[key].isReady()) return false;
		return true;
	}
	_initGLContext() {
		this._caps = {
		...
		if (!this._glVendor) this._glVendor = this._gl.getParameter(this._gl.VENDOR) || "Unknown vendor";
		if (!this._glRenderer) this._glRenderer = this._gl.getParameter(this._gl.RENDERER) || "Unknown renderer";
		if (this._gl.HALF_FLOAT_OES !== 36193) this._gl.HALF_FLOAT_OES = 36193;
		if (this._gl.RGBA16F !== 34842) this._gl.RGBA16F = 34842;
		if (this._gl.RGBA32F !== 34836) this._gl.RGBA32F = 34836;
		if (this._gl.DEPTH24_STENCIL8 !== 35056) this._gl.DEPTH24_STENCIL8 = 35056;
		if (this._caps.timerQuery) {
			if (this._webGLVersion === 1) this._gl.getQuery = this._caps.timerQuery.getQueryEXT.bind(this._caps.timerQuery);
		...
		if (this._caps.bptc) this._gl.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT = this._caps.bptc.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT;
		...
		if (this._webGLVersion > 1) {
			if (this._gl.HALF_FLOAT_OES !== 5131) this._gl.HALF_FLOAT_OES = 5131;
		}
		...
		if (this._webGLVersion > 1) {
			...
			if (drawBuffersExtension !== null) {
				...
				for (let i = 0; i < 16; i++) this._gl["COLOR_ATTACHMENT" + i + "_WEBGL"] = drawBuffersExtension["COLOR_ATTACHMENT" + i + "_WEBGL"];
			}
		}
		if (this._webGLVersion > 1) this._caps.depthTextureExtension = true;
		else {
		...
		if (this.disableVertexArrayObjects) this._caps.vertexArrayObject = false;
		else if (this._webGLVersion > 1) this._caps.vertexArrayObject = true;
		else {
		...
		if (this._webGLVersion > 1) this._caps.instancedArrays = true;
		else {
			...
			} else this._caps.instancedArrays = false;
		}
		if (this._gl.getShaderPrecisionFormat) {
			...
			if (!this._shouldUseHighPrecisionShader) {
				...
				if (vertexmedp && fragmentmedp) this._caps.shaderFloatPrecision = Math.min(vertexmedp.precision, fragmentmedp.precision);
			}
			if (this._caps.shaderFloatPrecision < 10) this._caps.shaderFloatPrecision = 10;
		}
		if (this._webGLVersion > 1) this._caps.blendMinMax = true;
		else {
		...
		if (!this._caps.supportSRGBBuffers) {
			...
			if (this._creationOptions) {
				...
				if (forceSRGBBufferSupportState !== void 0) this._caps.supportSRGBBuffers = this._caps.supportSRGBBuffers && forceSRGBBufferSupportState;
			}
		}
		...
		for (let slot = 0; slot < this._maxSimultaneousTextures; slot++) this._nextFreeTextureSlots.push(slot);
		if (this._glRenderer === "Mali-G72") this._caps.disableMorphTargetTexture = true;
	}
	_initFeatures() {
		this._features = {
	...
	*/
	...
	_prepareWorkingCanvas() {
		...
		if (context) this._workingContext = context;
	}
	/**
	...
	*/
	...
	extractDriverInfo() {
		...
		if (glInfo && glInfo.renderer) return glInfo.renderer;
		return "";
	}
	/**
	...
	*/
	getRenderWidth(useScreen = false) {
		if (!useScreen && this._currentRenderTarget) return this._currentRenderTarget.width;
	...
	*/
	getRenderHeight(useScreen = false) {
		if (!useScreen && this._currentRenderTarget) return this._currentRenderTarget.height;
	...
	*/
	endFrame() {
		super.endFrame();
		if (this._badOS) this.flushFramebuffer();
	}
	/**
	...
	*/
	bindFramebuffer(rtWrapper, faceIndex = 0, requiredWidth, requiredHeight, forceFullscreenViewport, lodLevel = 0, layer = 0) {
		...
		if (this._currentRenderTarget) this._resolveAndGenerateMipMapsFramebuffer(this._currentRenderTarget);
		...
		if (!rtWrapper.isMulti) {
			...
			} else if (rtWrapper.isCube) gl.framebufferTexture2D(gl.FRAMEBUFFER, gl.COLOR_ATTACHMENT0, gl.TEXTURE_CUBE_MAP_POSITIVE_X + faceIndex, rtWrapper.texture._hardwareTexture?.underlyingResource, lodLevel);
		...
		if (depthStencilTexture) {
			if (rtWrapper.is3D) {
				if (rtWrapper.texture.width !== depthStencilTexture.width || rtWrapper.texture.height !== depthStencilTexture.height || rtWrapper.texture.depth !== depthStencilTexture.depth) Logger.Warn("Depth/Stencil attachment for 3D target must have same dimensions as color attachment");
			}
			const attachment = rtWrapper._depthStencilTextureWithStencil ? gl.DEPTH_STENCIL_ATTACHMENT : gl.DEPTH_ATTACHMENT;
			if (rtWrapper.is2DArray || rtWrapper.is3D) gl.framebufferTextureLayer(gl.FRAMEBUFFER, attachment, depthStencilTexture._hardwareTexture?.underlyingResource, lodLevel, layer);
			else if (rtWrapper.isCube) gl.framebufferTexture2D(gl.FRAMEBUFFER, attachment, gl.TEXTURE_CUBE_MAP_POSITIVE_X + faceIndex, depthStencilTexture._hardwareTexture?.underlyingResource, lodLevel);
			else gl.framebufferTexture2D(gl.FRAMEBUFFER, attachment, gl.TEXTURE_2D, depthStencilTexture._hardwareTexture?.underlyingResource, lodLevel);
		}
		if (webglRtWrapper._MSAAFramebuffer) this._bindUnboundFramebuffer(webglRtWrapper._MSAAFramebuffer);
		if (this._cachedViewport && !forceFullscreenViewport) this.setViewport(this._cachedViewport, requiredWidth, requiredHeight);
		else {
			if (!requiredWidth) {
				requiredWidth = rtWrapper.width;
				if (lodLevel) requiredWidth = requiredWidth / Math.pow(2, lodLevel);
			}
			if (!requiredHeight) {
				requiredHeight = rtWrapper.height;
				if (lodLevel) requiredHeight = requiredHeight / Math.pow(2, lodLevel);
			}
	...
	setStateCullFaceType(cullBackFaces, force) {
		...
		if (this._depthCullingState.cullFace !== cullFace || force) this._depthCullingState.cullFace = cullFace;
	}
	/**
	...
	*/
	setState(culling, zOffset = 0, force, reverseSide = false, cullBackFaces, stencil, zOffsetUnits = 0) {
		if (this._depthCullingState.cull !== culling || force) this._depthCullingState.cull = culling;
		this.setStateCullFaceType(cullBackFaces, force);
		this.setZOffset(zOffset);
		this.setZOffsetUnits(zOffsetUnits);
		const frontFace = reverseSide ? this._gl.CW : this._gl.CCW;
		if (this._depthCullingState.frontFace !== frontFace || force) this._depthCullingState.frontFace = frontFace;
		this._stencilStateComposer.stencilMaterial = stencil;
	}
	_resolveAndGenerateMipMapsFramebuffer(texture, disableGenerateMipMaps = false) {
		if (!texture.disableAutomaticMSAAResolve) {
			if (texture.isMulti) this.resolveMultiFramebuffer(texture);
			else this.resolveFramebuffer(texture);
		}
		if (!disableGenerateMipMaps) {
			if (texture.isMulti) this.generateMipMapsMultiFramebuffer(texture);
			else this.generateMipMapsFramebuffer(texture);
		}
	}
	/**
	* @internal
	...
	*/
	unBindFramebuffer(texture, disableGenerateMipMaps, onBeforeUnbind) {
		...
		if (onBeforeUnbind) {
			if (webglRtWrapper._MSAAFramebuffer) this._bindUnboundFramebuffer(webglRtWrapper._framebuffer);
			onBeforeUnbind();
		}
	...
	*/
	generateMipMapsFramebuffer(texture) {
		if (!texture.isMulti && texture.texture?.generateMipMaps && !texture.isCube) this.generateMipmaps(texture.texture);
	}
	/**
	...
	*/
	resolveFramebuffer(texture) {
		...
		const gl = this._gl;
		if (!rtWrapper._MSAAFramebuffer || rtWrapper.isMulti) return;
	...
	*/
	restoreDefaultFramebuffer() {
		if (this._currentRenderTarget) this.unBindFramebuffer(this._currentRenderTarget);
		else this._bindUnboundFramebuffer(null);
		if (this._cachedViewport) this.setViewport(this._cachedViewport);
		this.wipeCaches();
	}
	/** @internal */
	...
	*/
	...
	_createVertexBuffer(data, usage) {
		...
		if (!vbo) throw new Error("Unable to create vertex buffer");
	...
	*/
	createIndexBuffer(indices, updatable, _label) {
		const vbo = this._gl.createBuffer();
		const dataBuffer = new WebGLDataBuffer(vbo);
		if (!vbo) throw new Error("Unable to create index buffer");
	...
	_normalizeIndexData(indices) {
		if (indices.BYTES_PER_ELEMENT === 2) return indices;
		if (this._caps.uintIndices) {
			if (indices instanceof Uint32Array) return indices;
			else {
				for (let index = 0; index < indices.length; index++) if (indices[index] >= 65535) return new Uint32Array(indices);
	...
	*/
	bindArrayBuffer(buffer) {
		if (!this._vaoRecordInProgress) this._unbindVertexArrayObject();
	...
	*/
	...
	_vertexAttribPointer(buffer, indx, size, type, normalized, stride, offset) {
		...
		if (changed || this._vaoRecordInProgress) {
			...
			if (type === this._gl.UNSIGNED_INT || type === this._gl.INT) this._gl.vertexAttribIPointer(indx, size, type, stride, offset);
			else this._gl.vertexAttribPointer(indx, size, type, normalized, stride, offset);
		}
	}
	/**
	* @internal
	...
	_bindVertexBuffersAttributes(vertexBuffers, effect, overrideVertexBuffers) {
		...
		for (let index = 0; index < attributes.length; index++) {
			...
			if (order >= 0) {
				...
				if (overrideVertexBuffers) vertexBuffer = overrideVertexBuffers[ai];
				if (!vertexBuffer) vertexBuffer = vertexBuffers[ai];
				if (!vertexBuffer) continue;
				this._gl.enableVertexAttribArray(order);
				if (!this._vaoRecordInProgress) this._vertexAttribArraysEnabled[order] = true;
	...
	*/
	bindBuffersDirectly(vertexBuffer, indexBuffer, vertexDeclaration, vertexStrideSize, effect) {
		if (this._cachedVertexBuffers !== vertexBuffer || this._cachedEffectForVertexBuffers !== effect) {
			...
			this.unbindAllAttributes();
			let offset = 0;
			for (let index = 0; index < attributesCount; index++) if (index < vertexDeclaration.length) {
				const order = effect.getAttributeLocation(index);
				if (order >= 0) {
					this._gl.enableVertexAttribArray(order);
	...
	_unbindVertexArrayObject() {
		if (!this._cachedVertexArrayObject) return;
	...
	*/
	updateAndBindInstancesBuffer(instancesBuffer, data, offsetLocations) {
		this.bindArrayBuffer(instancesBuffer);
		if (data) this._gl.bufferSubData(this._gl.ARRAY_BUFFER, 0, data);
		if (offsetLocations[0].index !== void 0) this.bindInstancesBuffer(instancesBuffer, offsetLocations, true);
	...
	*/
	bindInstancesBuffer(instancesBuffer, attributesInfo, computeStride = true) {
		this.bindArrayBuffer(instancesBuffer);
		let stride = 0;
		if (computeStride) for (let i = 0; i < attributesInfo.length; i++) {
			const ai = attributesInfo[i];
			stride += ai.attributeSize * 4;
		}
		for (let i = 0; i < attributesInfo.length; i++) {
			const ai = attributesInfo[i];
			if (ai.index === void 0) ai.index = this._currentEffect.getAttributeLocationByName(ai.attributeName);
	...
	*/
	drawElementsType(fillMode, indexStart, indexCount, instancesCount) {
		...
		if (instancesCount) this._gl.drawElementsInstanced(drawMode, indexCount, indexFormat, indexStart * mult, instancesCount);
		else this._gl.drawElements(drawMode, indexCount, indexFormat, indexStart * mult);
	}
	/**
	* Draw a list of unindexed primitives
	* @param fillMode defines the primitive to use
	...
	*/
	drawArraysType(fillMode, verticesStart, verticesCount, instancesCount) {
		...
		this._reportDrawCall();
		const drawMode = this._drawMode(fillMode);
		if (instancesCount) this._gl.drawArraysInstanced(drawMode, verticesStart, verticesCount, instancesCount);
		else this._gl.drawArrays(drawMode, verticesStart, verticesCount);
	}
	_drawMode(fillMode) {
		switch (fillMode) {
			case 0: return this._gl.TRIANGLES;
			case 2: return this._gl.POINTS;
			case 1: return this._gl.LINES;
			case 3: return this._gl.POINTS;
			case 4: return this._gl.LINES;
			case 5: return this._gl.LINE_LOOP;
			case 6: return this._gl.LINE_STRIP;
			case 7: return this._gl.TRIANGLE_STRIP;
			case 8: return this._gl.TRIANGLE_FAN;
			default: return this._gl.TRIANGLES;
		}
	}
	/**
	* @internal
	*/
	_releaseEffect(effect) {
		if (this._compiledEffects[effect._key]) delete this._compiledEffects[effect._key];
		const pipelineContext = effect.getPipelineContext();
		if (pipelineContext) this._deletePipelineContext(pipelineContext);
	}
	/**
	* @internal
	*/
	_deletePipelineContext(pipelineContext) {
		...
		if (webGLPipelineContext && webGLPipelineContext.program) {
			...
			if (this._gl) {
				if (this._currentProgram === webGLPipelineContext.program) this._setProgram(null);
	...
	*/
	createEffect(baseName, attributesNamesOrOptions, uniformsNamesOrEngine, samplers, defines, fallbacks, onCompiled, onError, indexParameters, shaderLanguage = 0, extraInitializationsAsync) {
		...
		if (globalDefines) fullDefines += globalDefines;
		...
		if (this._gl) getStateObject(this._gl);
	...
	*/
	getUniforms(pipelineContext, uniformsNames) {
		...
		const webGLPipelineContext = pipelineContext;
		for (let index = 0; index < uniformsNames.length; index++) results.push(this._gl.getUniformLocation(webGLPipelineContext.program, uniformsNames[index]));
		return results;
	}
	/**
	...
	*/
	getAttributes(pipelineContext, attributesNames) {
		const results = [];
		const webGLPipelineContext = pipelineContext;
		for (let index = 0; index < attributesNames.length; index++) try {
	...
	*/
	enableEffect(effect) {
		...
		if (!effect || effect === this._currentEffect) return;
		this._stencilStateComposer.stencilMaterial = void 0;
		this.bindSamplers(effect);
		this._currentEffect = effect;
		if (effect.onBind) effect.onBind(effect);
		if (effect._onBindObservable) effect._onBindObservable.notifyObservers(effect);
	}
	/**
	...
	*/
	setIntArray2(uniform, array) {
		if (!uniform || array.length % 2 !== 0) return false;
	...
	*/
	setIntArray3(uniform, array) {
		if (!uniform || array.length % 3 !== 0) return false;
	...
	*/
	setIntArray4(uniform, array) {
		if (!uniform || array.length % 4 !== 0) return false;
	...
	*/
	wipeCaches(bruteForce) {
		if (this.preventCacheWipeBetweenFrames && !bruteForce) return;
	...
	*/
	_getSamplingParameters(samplingMode, generateMipMaps) {
		...
		switch (samplingMode) {
			case 11:
				magFilter = gl.LINEAR;
				if (generateMipMaps) minFilter = gl.LINEAR_MIPMAP_NEAREST;
				else minFilter = gl.LINEAR;
				break;
			case 3:
				magFilter = gl.LINEAR;
				hasMipMaps = true;
				if (generateMipMaps) minFilter = gl.LINEAR_MIPMAP_LINEAR;
				else minFilter = gl.LINEAR;
				break;
			case 8:
				hasMipMaps = true;
				magFilter = gl.NEAREST;
				if (generateMipMaps) minFilter = gl.NEAREST_MIPMAP_LINEAR;
				else minFilter = gl.NEAREST;
				break;
			case 4:
				magFilter = gl.NEAREST;
				if (generateMipMaps) minFilter = gl.NEAREST_MIPMAP_NEAREST;
				else minFilter = gl.NEAREST;
				break;
			case 5:
				magFilter = gl.NEAREST;
	...
	*/
	_createInternalTexture(size, options, delayGPUTextureCreation = true, source = 0) {
		...
		} else generateMipMaps = !!options;
		useSRGBBuffer && (useSRGBBuffer = this._caps.supportSRGBBuffers && (this.webGLVersion > 1 || this.isWebGPU));
		if (type === 1 && !this._caps.textureFloatLinearFiltering) samplingMode = 1;
		else if (type === 2 && !this._caps.textureHalfFloatLinearFiltering) samplingMode = 1;
		...
		if (layers !== 0) {
			...
			texture.isCube = true;
			for (let face = 0; face < 6; face++) gl.texImage2D(gl.TEXTURE_CUBE_MAP_POSITIVE_X + face, 0, sizedFormat, width, height, 0, internalFormat, textureType, null);
		} else gl.texImage2D(target, 0, sizedFormat, width, height, 0, internalFormat, textureType, null);
		...
		if (generateMipMaps || createMipMaps) this._gl.generateMipmap(target);
		this._bindTextureDirectly(target, null);
		...
		if (createMSAATexture) {
			let renderBuffer;
			if (IsDepthTexture(texture.format)) renderBuffer = this._setupFramebufferDepthAttachments(HasStencilAspect(texture.format), texture.format !== 19, texture.width, texture.height, samples, texture.format, true);
			else renderBuffer = this._createRenderBuffer(texture.width, texture.height, samples, -1, this._getRGBABufferInternalSizedFormat(texture.type, texture.format, texture._useSRGBBuffer), -1);
			if (!renderBuffer) throw new Error("Unable to create render buffer");
			texture._autoMSAAManagement = true;
			let hardwareTexture = texture._hardwareTexture;
			if (!hardwareTexture) hardwareTexture = texture._hardwareTexture = this._createHardwareTexture();
	...
	createTexture(url, noMipmap, invertY, scene, samplingMode = 3, onLoad = null, onError = null, buffer = null, fallback = null, format = null, forcedExtension = null, mimeType, loaderOptions, creationFlags, useSRGBBuffer) {
		return this._createTextureBase(url, noMipmap, invertY, scene, samplingMode, onLoad, onError, (...args) => this._prepareWebGLTexture(...args, format), (potWidth, potHeight, img, extension, texture, continuationCallback) => {
			...
			if (img.width > maxTextureSize || img.height > maxTextureSize || !this._supportsHardwareTextureRescaling) {
				...
				if (!this._workingCanvas || !this._workingContext) return false;
	...
	*/
	_unpackFlipY(value) {
		if (this._unpackFlipYCached !== value) {
			...
			if (this.enableUnpackFlipYCached) this._unpackFlipYCached = value;
		}
	}
	/** @internal */
	...
	_getTextureTarget(texture) {
		if (texture.isCube) return this._gl.TEXTURE_CUBE_MAP;
		else if (texture.is3D) return this._gl.TEXTURE_3D;
		else if (texture.is2DArray || texture.isMultiview) return this._gl.TEXTURE_2D_ARRAY;
	...
	*/
	_uploadCompressedDataToTextureDirectly(texture, internalFormat, width, height, data, faceIndex = 0, lod = 0) {
		...
		if (texture.isCube) target = gl.TEXTURE_CUBE_MAP_POSITIVE_X + faceIndex;
		if (texture._useSRGBBuffer) switch (internalFormat) {
			case 37492:
			case 36196:
				if (this._caps.etc2) internalFormat = gl.COMPRESSED_SRGB8_ETC2;
				else texture._useSRGBBuffer = false;
				break;
			case 37496:
				if (this._caps.etc2) internalFormat = gl.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC;
				else texture._useSRGBBuffer = false;
				break;
			case 36492:
			...
			case 37821:
				...
				break;
			case 33776:
				if (this._caps.s3tc_srgb) internalFormat = gl.COMPRESSED_SRGB_S3TC_DXT1_EXT;
				else texture._useSRGBBuffer = false;
				break;
			case 33777:
				if (this._caps.s3tc_srgb) internalFormat = gl.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;
				else texture._useSRGBBuffer = false;
				break;
			case 33779:
				if (this._caps.s3tc_srgb) internalFormat = gl.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT;
				else texture._useSRGBBuffer = false;
				break;
			default: texture._useSRGBBuffer = false;
		}
		...
		} else this._gl.compressedTexImage2D(target, lod, internalFormat, width, height, 0, data);
	}
	/**
	* @internal
	*/
	...
	*/
	updateTextureData(texture, imageData, xOffset, yOffset, width, height, faceIndex = 0, lod = 0, generateMipMaps = false) {
		...
		if (generateMipMaps) this._gl.generateMipmap(target);
	...
	*/
	...
	_prepareWebGLTextureContinuation(texture, scene, noMipmap, isCompressed, samplingMode) {
		...
		if (!noMipmap && !isCompressed) gl.generateMipmap(gl.TEXTURE_2D);
	...
	_getInternalFormatFromDepthTextureFormat(textureFormat, hasDepth, hasStencil) {
		const gl = this._gl;
		if (!hasDepth) return gl.STENCIL_INDEX8;
		let internalFormat = hasStencil ? gl.DEPTH_STENCIL : gl.DEPTH_COMPONENT;
		if (this.webGLVersion > 1) {
			if (textureFormat === 15) internalFormat = gl.DEPTH_COMPONENT16;
			else if (textureFormat === 16) internalFormat = gl.DEPTH_COMPONENT24;
			else if (textureFormat === 17 || textureFormat === 13) internalFormat = hasStencil ? gl.DEPTH24_STENCIL8 : gl.DEPTH_COMPONENT24;
		...
		} else internalFormat = gl.DEPTH_COMPONENT16;
		return internalFormat;
	}
	_getWebGLTextureTypeFromDepthTextureFormat(textureFormat) {
		const gl = this._gl;
		let type = gl.UNSIGNED_INT;
		if (textureFormat === 15) type = gl.UNSIGNED_SHORT;
		else if (textureFormat === 17 || textureFormat === 13) type = gl.UNSIGNED_INT_24_8;
		else if (textureFormat === 14) type = gl.FLOAT;
		else if (textureFormat === 18) type = gl.FLOAT_32_UNSIGNED_INT_24_8_REV;
		else if (textureFormat === 19) type = gl.UNSIGNED_BYTE;
		return type;
	}
	/**
	* @internal
	*/
	_setupFramebufferDepthAttachments(generateStencilBuffer, generateDepthBuffer, width, height, samples = 1, depthTextureFormat, dontBindRenderBufferToFrameBuffer = false) {
		...
		if (generateStencilBuffer && generateDepthBuffer) return this._createRenderBuffer(width, height, samples, gl.DEPTH_STENCIL, internalFormat, dontBindRenderBufferToFrameBuffer ? -1 : gl.DEPTH_STENCIL_ATTACHMENT);
		if (generateDepthBuffer) return this._createRenderBuffer(width, height, samples, internalFormat, internalFormat, dontBindRenderBufferToFrameBuffer ? -1 : gl.DEPTH_ATTACHMENT);
		if (generateStencilBuffer) return this._createRenderBuffer(width, height, samples, internalFormat, internalFormat, dontBindRenderBufferToFrameBuffer ? -1 : gl.STENCIL_ATTACHMENT);
		return null;
	}
	/**
	* @internal
	*/
	...
	_updateRenderBuffer(renderBuffer, width, height, samples, internalFormat, msInternalFormat, attachment, unbindBuffer = true) {
		...
		if (samples > 1 && gl.renderbufferStorageMultisample) gl.renderbufferStorageMultisample(gl.RENDERBUFFER, samples, msInternalFormat, width, height);
		else gl.renderbufferStorage(gl.RENDERBUFFER, internalFormat, width, height);
		if (attachment !== -1) gl.framebufferRenderbuffer(gl.FRAMEBUFFER, attachment, gl.RENDERBUFFER, renderBuffer);
		if (unbindBuffer) gl.bindRenderbuffer(gl.RENDERBUFFER, null);
		return renderBuffer;
	}
	/**
	* @internal
	*/
	_releaseTexture(texture) {
		...
		if (index !== -1) this._internalTexturesCache.splice(index, 1);
		if (texture._lodTextureHigh) texture._lodTextureHigh.dispose();
		if (texture._lodTextureMid) texture._lodTextureMid.dispose();
		if (texture._lodTextureLow) texture._lodTextureLow.dispose();
		if (texture._irradianceTexture) texture._irradianceTexture.dispose();
	}
	...
	*/
	bindSamplers(effect) {
		...
		for (let index = 0; index < samplers.length; index++) {
			...
			if (uniform) this._boundUniforms[index] = uniform;
		}
		this._currentEffect = null;
	}
	...
	*/
	_bindTextureDirectly(target, texture, forTextureDataUpdate = false, force = false) {
		...
		if (forTextureDataUpdate && isTextureForRendering) this._activeChannel = texture._associatedChannel;
		if (this._boundTexturesCache[this._activeChannel] !== texture || force) {
			...
			} else this._gl.bindTexture(target, texture?._hardwareTexture?.underlyingResource ?? null);
			this._boundTexturesCache[this._activeChannel] = texture;
			if (texture) texture._associatedChannel = this._activeChannel;
		} else if (forTextureDataUpdate) {
			wasPreviouslyBound = true;
			this._activateCurrentTexture();
		}
		if (isTextureForRendering && !forTextureDataUpdate) this._bindSamplerUniformToChannel(texture._associatedChannel, this._activeChannel);
	...
	*/
	_bindTexture(channel, texture, name) {
		...
		if (texture) texture._associatedChannel = channel;
	...
	*/
	setTexture(channel, uniform, texture, name) {
		if (channel === void 0) return;
		if (uniform) this._boundUniforms[channel] = uniform;
		this._setTexture(channel, texture);
	}
	_bindSamplerUniformToChannel(sourceSlot, destination) {
		const uniform = this._boundUniforms[sourceSlot];
		if (!uniform || uniform._currentState === destination) return;
		this._gl.uniform1i(uniform, destination);
		uniform._currentState = destination;
	}
	_getTextureWrapMode(mode) {
		switch (mode) {
			case 1: return this._gl.REPEAT;
			case 0: return this._gl.CLAMP_TO_EDGE;
			case 2: return this._gl.MIRRORED_REPEAT;
		}
	...
	_setTexture(channel, texture, isPartOfTextureArray = false, depthStencilTexture = false, name = "") {
		...
		if (texture.video) {
			...
			if (videoInternalTexture) videoInternalTexture._associatedChannel = channel;
			texture.update();
		...
		let internalTexture;
		if (depthStencilTexture) internalTexture = texture.depthStencilTexture;
		else if (texture.isReady()) internalTexture = texture.getInternalTexture();
		else if (texture.isCube) internalTexture = this.emptyCubeTexture;
		else if (texture.is3D) internalTexture = this.emptyTexture3D;
		else if (texture.is2DArray) internalTexture = this.emptyTexture2DArray;
		else internalTexture = this.emptyTexture;
		if (!isPartOfTextureArray && internalTexture) internalTexture._associatedChannel = channel;
		let needToBind = true;
		if (this._boundTexturesCache[channel] === internalTexture) {
			if (!isPartOfTextureArray) this._bindSamplerUniformToChannel(internalTexture._associatedChannel, channel);
			needToBind = false;
		}
		this._activeChannel = channel;
		const target = this._getTextureTarget(internalTexture);
		if (needToBind) this._bindTextureDirectly(target, internalTexture, isPartOfTextureArray);
	...
	*/
	setTextureArray(channel, uniform, textures, name) {
		if (channel === void 0 || !uniform) return;
		if (!this._textureUnits || this._textureUnits.length !== textures.length) this._textureUnits = new Int32Array(textures.length);
		for (let i = 0; i < textures.length; i++) {
			const texture = textures[i].getInternalTexture();
			if (texture) {
				this._textureUnits[i] = channel + i;
				texture._associatedChannel = channel + i;
			} else this._textureUnits[i] = -1;
		}
		this._gl.uniform1iv(uniform, this._textureUnits);
		for (let index = 0; index < textures.length; index++) this._setTexture(this._textureUnits[index], textures[index], true);
	}
	/**
	* @internal
	*/
	_setAnisotropicLevel(target, internalTexture, anisotropicFilteringLevel) {
		...
		if (internalTexture.samplingMode !== 11 && internalTexture.samplingMode !== 3 && internalTexture.samplingMode !== 2) anisotropicFilteringLevel = 1;
	...
	_setTextureParameterInteger(target, parameter, value, texture) {
		if (texture) this._bindTextureDirectly(target, texture, true, true);
	...
	*/
	unbindAllAttributes() {
		if (this._mustWipeVertexAttributes) {
			this._mustWipeVertexAttributes = false;
			for (let i = 0; i < this._caps.maxVertexAttribs; i++) this.disableAttributeByIndex(i);
			return;
		}
		for (let i = 0, ul = this._vertexAttribArraysEnabled.length; i < ul; i++) {
			if (i >= this._caps.maxVertexAttribs || !this._vertexAttribArraysEnabled[i]) continue;
	...
	dispose() {
		if (IsWindowObjectExist()) {
			if (this._renderingCanvas) {
				...
				if (this._onContextRestored) this._renderingCanvas.removeEventListener("webglcontextrestored", this._onContextRestored);
			}
		}
		super.dispose();
		if (this._dummyFramebuffer) this._gl.deleteFramebuffer(this._dummyFramebuffer);
		this.unbindAllAttributes();
		this._boundUniforms = {};
		...
		this._currentProgram = null;
		if (this._creationOptions.loseContextOnDispose) this._gl.getExtension("WEBGL_lose_context")?.loseContext();
		deleteStateObject(this._gl);
	}
	/**
	...
	*/
	attachContextLostEvent(callback) {
		if (this._renderingCanvas) this._renderingCanvas.addEventListener("webglcontextlost", callback, false);
	}
	/**
	...
	*/
	attachContextRestoredEvent(callback) {
		if (this._renderingCanvas) this._renderingCanvas.addEventListener("webglcontextrestored", callback, false);
	}
	/**
	...
	*/
	...
	_canRenderToFloatFramebuffer() {
		if (this._webGLVersion > 1) return this._caps.colorBufferFloat;
	...
	*/
	_getWebGLTextureType(type) {
		if (this._webGLVersion === 1) {
			switch (type) {
				case 1: return this._gl.FLOAT;
				case 2: return this._gl.HALF_FLOAT_OES;
				case 0: return this._gl.UNSIGNED_BYTE;
				case 8: return this._gl.UNSIGNED_SHORT_4_4_4_4;
				case 9: return this._gl.UNSIGNED_SHORT_5_5_5_1;
				case 10: return this._gl.UNSIGNED_SHORT_5_6_5;
			}
			return this._gl.UNSIGNED_BYTE;
		}
		switch (type) {
			case 3: return this._gl.BYTE;
			case 0: return this._gl.UNSIGNED_BYTE;
			case 4: return this._gl.SHORT;
			case 5: return this._gl.UNSIGNED_SHORT;
			case 6: return this._gl.INT;
			case 7: return this._gl.UNSIGNED_INT;
			case 1: return this._gl.FLOAT;
			case 2: return this._gl.HALF_FLOAT;
			case 8: return this._gl.UNSIGNED_SHORT_4_4_4_4;
			case 9: return this._gl.UNSIGNED_SHORT_5_5_5_1;
			case 10: return this._gl.UNSIGNED_SHORT_5_6_5;
			case 11: return this._gl.UNSIGNED_INT_2_10_10_10_REV;
			case 12: return this._gl.UNSIGNED_INT_24_8;
			case 13: return this._gl.UNSIGNED_INT_10F_11F_11F_REV;
			case 14: return this._gl.UNSIGNED_INT_5_9_9_9_REV;
			case 15: return this._gl.FLOAT_32_UNSIGNED_INT_24_8_REV;
		}
		return this._gl.UNSIGNED_BYTE;
	}
	/**
	...
	*/
	_getInternalFormat(format, useSRGBBuffer = false) {
		...
		switch (format) {
			...
			case 5:
			case 32859:
			case 36763: internalFormat = useSRGBBuffer ? this._glSRGBExtensionValues.SRGB8_ALPHA8 : this._gl.RGBA;
		}
		if (this._webGLVersion > 1) switch (format) {
			case 8:
			...
			case 10:
				...
				break;
			case 11: internalFormat = this._gl.RGBA_INTEGER;
		}
		return internalFormat;
	}
	/**
	...
	*/
	_getRGBABufferInternalSizedFormat(type, format, useSRGBBuffer = false) {
		if (this._webGLVersion === 1) {
			if (format !== void 0) switch (format) {
				case 0: return this._gl.ALPHA;
				case 1: return this._gl.LUMINANCE;
				case 2: return this._gl.LUMINANCE_ALPHA;
				case 4: return useSRGBBuffer ? this._glSRGBExtensionValues.SRGB : this._gl.RGB;
			}
			return this._gl.RGBA;
		}
		switch (type) {
			case 3: switch (format) {
				case 6: return this._gl.R8_SNORM;
				case 7: return this._gl.RG8_SNORM;
				case 4: return this._gl.RGB8_SNORM;
				case 8: return this._gl.R8I;
				case 9: return this._gl.RG8I;
				case 10: return this._gl.RGB8I;
				case 11: return this._gl.RGBA8I;
				default: return this._gl.RGBA8_SNORM;
			}
			case 0: switch (format) {
				case 6: return this._gl.R8;
				case 7: return this._gl.RG8;
				case 4: return useSRGBBuffer ? this._glSRGBExtensionValues.SRGB8 : this._gl.RGB8;
				case 5: return useSRGBBuffer ? this._glSRGBExtensionValues.SRGB8_ALPHA8 : this._gl.RGBA8;
				case 8: return this._gl.R8UI;
				case 9: return this._gl.RG8UI;
				case 10: return this._gl.RGB8UI;
				case 11: return this._gl.RGBA8UI;
				case 0: return this._gl.ALPHA;
				case 1: return this._gl.LUMINANCE;
				case 2: return this._gl.LUMINANCE_ALPHA;
				default: return this._gl.RGBA8;
			}
			case 4: switch (format) {
				case 8: return this._gl.R16I;
				case 36760: return this._gl.R16_SNORM_EXT;
				case 36761: return this._gl.RG16_SNORM_EXT;
				case 36762: return this._gl.RGB16_SNORM_EXT;
				case 36763: return this._gl.RGBA16_SNORM_EXT;
				case 9: return this._gl.RG16I;
				case 10: return this._gl.RGB16I;
				case 11: return this._gl.RGBA16I;
				default: return this._gl.RGBA16I;
			}
			case 5: switch (format) {
				case 8: return this._gl.R16UI;
				case 33322: return this._gl.R16_EXT;
				case 33324: return this._gl.RG16_EXT;
				case 32852: return this._gl.RGB16_EXT;
				case 32859: return this._gl.RGBA16_EXT;
				case 9: return this._gl.RG16UI;
				case 10: return this._gl.RGB16UI;
				case 11: return this._gl.RGBA16UI;
				default: return this._gl.RGBA16UI;
			}
			case 6: switch (format) {
				case 8: return this._gl.R32I;
				case 9: return this._gl.RG32I;
				case 10: return this._gl.RGB32I;
				case 11: return this._gl.RGBA32I;
				default: return this._gl.RGBA32I;
			}
			case 7: switch (format) {
				case 8: return this._gl.R32UI;
				case 9: return this._gl.RG32UI;
				case 10: return this._gl.RGB32UI;
				case 11: return this._gl.RGBA32UI;
				default: return this._gl.RGBA32UI;
			}
			case 1: switch (format) {
				case 6: return this._gl.R32F;
				case 7: return this._gl.RG32F;
				case 4: return this._gl.RGB32F;
				case 5: return this._gl.RGBA32F;
				default: return this._gl.RGBA32F;
			}
			case 2: switch (format) {
				case 6: return this._gl.R16F;
				case 7: return this._gl.RG16F;
				case 4: return this._gl.RGB16F;
				case 5: return this._gl.RGBA16F;
				default: return this._gl.RGBA16F;
			}
			case 10: return this._gl.RGB565;
			case 13: return this._gl.R11F_G11F_B10F;
			case 14: return this._gl.RGB9_E5;
			case 8: return this._gl.RGBA4;
			case 9: return this._gl.RGB5_A1;
			case 11: switch (format) {
				case 5: return this._gl.RGB10_A2;
				case 11: return this._gl.RGB10_A2UI;
				default: return this._gl.RGB10_A2;
			}
		}
	...
	*/
	readPixels(x, y, width, height, hasAlpha = true, flushRenderer = true, data = null) {
		...
		if (!data) data = new Uint8Array(dataLength);
		...
		if (flushRenderer) this.flushFramebuffer();
	...
	*/
	static isSupported() {
		if (this._HasMajorPerformanceCaveat !== null) return !this._HasMajorPerformanceCaveat;
		if (this._IsSupported === null) try {
	...
	*/
	static get HasMajorPerformanceCaveat() {
		if (this._HasMajorPerformanceCaveat === null) try {
			const tempcanvas = AbstractEngine._CreateCanvas(1, 1);
...
//#endregion
export { IsDepthTexture as a, WebGL2ShaderProcessor as c, DataBuffer as d, HasStencilAspect as i, WebGLShaderProcessor as l, thinEngine_pure_exports as n, WebGLHardwareTexture as o, GetTypeForDepthTexture as r, WebGLDataBuffer as s, ThinEngine as t, IsWrapper as u };

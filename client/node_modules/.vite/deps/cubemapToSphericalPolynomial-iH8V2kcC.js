...
import { o as Vector3, w as ToLinearSpace } from "./math.vector.pure-BrntvQ1d.js";
import { t as Color3 } from "./math.color.pure-fTQ_mZgB.js";
import { n as SphericalPolynomial, t as SphericalHarmonics } from "./sphericalPolynomial.pure-uKVtrXes.js";
//#region ../../node_modules/.pnpm/@babylonjs+core@9.25.0/node_modules/@babylonjs/core/Misc/HighDynamicRange/cubemapToSphericalPolynomial.js
...
var CubeMapToSphericalPolynomialTools = class {
	...
	*/
	static _DownsampleFace(data, srcSize, dstSize, stride) {
		...
		for (let i = 0; i < dstLength; i++) dst[i] = avg[i] + .5 | 0;
		return dst;
	}
	/**
...
//#endregion
export { CubeMapToSphericalPolynomialTools as t };

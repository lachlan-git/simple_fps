import{t as e}from"./shaderStore-D-XQlhUT.js";import{t}from"./index-CcnEhoyr.js";var n=`gaussianSplattingVoxelPixelShader`,r=`var voxel_storage: texture_storage_3d<r8unorm,write>;var<storage,read_write> voxelOpacityBuffer: array<atomic<u32>>;
...
`;e.ShadersStoreWGSL[n]||(e.ShadersStoreWGSL[n]=r);var i=[t];for(let t of i)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var a={name:n,shader:r};export{a as gaussianSplattingVoxelPixelShaderWGSL};
import{t as e}from"./shaderStore-D-XQlhUT.js";import{t}from"./sceneUboDeclaration-B5VhSG0v.js";import{t as n}from"./meshUboDeclaration-BmNu2KU_.js";import{a as r,n as i,o as a}from"./index-CcnEhoyr.js";var o=`gaussianSplattingVoxelVertexShader`,s=`#include<__decl__gaussianSplattingVertex>
...
#endif
vPatchPosition=position.xy;}`;e.ShadersStore[o]||(e.ShadersStore[o]=s);var c=[a,t,n,i,r];for(let t of c)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var l={name:o,shader:s};export{l as gaussianSplattingVoxelVertexShader};
import{t as e}from"./shaderStore-D-XQlhUT.js";import{A as t,L as n,M as r,R as i,j as a,k as o}from"./index-CcnEhoyr.js";var s=`gpuRenderParticlesVertexShader`,c=`uniform view: mat4x4f;uniform projection: mat4x4f;uniform translationPivot: vec2f;uniform worldOffset: vec3f;
#ifdef LOCAL
...
`;e.ShadersStoreWGSL[s]||(e.ShadersStoreWGSL[s]=c);var l=[i,r,a,n,t,o];for(let t of l)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var u={name:s,shader:c};export{u as gpuRenderParticlesVertexShaderWGSL};
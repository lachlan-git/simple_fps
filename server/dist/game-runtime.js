...
export class GameRuntime {
    ...
    #shoot(code, attacker, yaw, pitch, nowMs) {
...
function createRuntimePlayer(identity, socket, config, spawnIndex) {
...
function allowMessage(player, nowMs) {
